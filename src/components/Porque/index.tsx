...
function Porque() {
  ...
  return (
    <Container>
      <Content>
        {isDesktop && (
          <ImgTreino src={Instrutor} alt="Instrutor" loading="lazy" />
        )}
        <Flex>
          {width > 768 && <Simbolo />}
          <Box>
            ...
            <Text>
              Além do benefício físico, e do aprendizado de técnicas de
              auto-defesa, os benefícios do Wing Chun também incluem:
            </Text>
            <List>
