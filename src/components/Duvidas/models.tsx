...
const duvidas: IDuvida[] = [
  ...
  },
  {
    ...
    text: (
      <Text>
        O Wing Chun pode ser praticado por pessoas de todas as idades, graças a sua filosofia de economia de
        movimento e energia.
        <br />
        <br />O mestre Yip Man, mestre de Bruce Lee, praticou o Wing Chun até sua morte, aos 79 anos!
      </Text>
    ),
  },
  {
    ...
    text: (
      <Text>
        Nossa escola trabalha utilizando como base as 3 formas do Wing Chun, como ensinado pelo mestre Yip
        Man:
        <br />
        <br />
        ...
        <br />
        <br />
        Chum Kiu, ou “a procura pela ponte”, ensina a olhar o inimigo de outro ângulo, de forma a encontrar
        seus pontos fracos.
        <br />
        <br />
  ...
  },
  {
    ...
    text: (
      <Text>
        ...
        <br />
        <br />O valor é revertido para o aluguel do espaço e aquisição de novos equipamentos
      </Text>
    ),
  },
  {
    ...
    text: (
      <Text>
        Nossa escola não cobra nenhum valor além da mensalidade, porém recomenda a aquisição de vestuário e
        equipamentos próprios para treino de Wing Chun.
        <br />
        <br />
